...
namespace ValidacionContrasena
{
    public class ValidacionContrasenaIteracion1UnitTest
    {
        ...
        [Fact]
        public void Si_ContraseñaFaltaGuionBajoNumeroMayuscula_Debe_Retonar_MensajeIndicandoQueFaltan()
        {
            //arrange
            GestorContrasenaBase gestorContrasena = new GestorContrasenaIteracion1("passswordddddddd");
